...
function VistaSecretaria({ usuario, empresaId, onCerrarSesion, onCambiarUsuario, onIrCalculadora, onIrInteligencia, onIrDespacho, onIrFactura, onIrProveedores, onVolverAlPanel, modoAdmin = false }) {
  ...
  // Determina título y subtítulo según modo
        ...
        <div className="p-6">
          ...
          {tabActivo === 'facturacion' && (
            <div className="space-y-4">
              ...
              <div className="bg-gray-50 border border-gray-200 rounded-xl p-6 text-center">
                ...
                <p className="text-gray-900 font-bold text-lg mb-2">Conduces de entrega</p>
                <p className="text-sm text-gray-600">
                  Próximamente: genera conduces individuales por escuela y por día
                </p>
              </div>
            </div>
          )}
          ...
          {tabActivo === 'gastos' && (
            <div className="text-center py-12">
              <p className="text-5xl mb-3">💸</p>
              <p className="text-gray-900 font-bold text-lg mb-2">Gastos Operativos</p>
              <p className="text-sm text-gray-600 mb-4">
                Próximamente: captura gastos con RNC, prorrateo, categorías
              </p>
          ...
          {tabActivo === 'compras' && (
            <div className="space-y-4">
                ...
                <div className="bg-amber-50 border border-amber-200 rounded-xl p-6">
                  <div className="flex items-center justify-between">
                    ...
                    <button
                      ...
                      className="bg-amber-600 hover:bg-amber-700 text-white px-6 py-3 rounded-lg font-bold transition whitespace-nowrap"
                    >
                      Abrir →
                    </button>
                  </div>
              ...
              <div className="bg-gray-50 border border-gray-200 rounded-xl p-6 text-center">
                <p className="text-4xl mb-3">📥</p>
                <p className="text-gray-900 font-bold text-lg mb-2">Registrar compras</p>
                <p className="text-sm text-gray-600">
                  Próximamente: registra compras, recepción de mercancía y control de stock
                </p>
              </div>
            </div>
          )}
